              ...
              <ul className="space-y-5">
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:transportesgrupochavez@gmail.com" className="text-sm font-semibold hover:text-accent transition-colors break-all">transportesgrupochavez@gmail.com</a>
                  </div>
                </li>
                <li className="flex gap-4">
                  <div className="w-10 h-10 rounded-lg bg-accent flex items-center justify-center flex-shrink-0">
